...
public class JAXRSConfiguration {
  ...
  public WebTarget sunshowerWebTarget(
      Client client, EnableJAXRS configuration, SunshowerTestServer server) {
  ...
  @Bean
  public static ProviderDependencyReorderingFactoryPostProcessor
      providerDependencyReorderingFactoryPostProcessor() {
    return new ProviderDependencyReorderingFactoryPostProcessor();
  }

  @Bean
  public Client jaxRsClient(ResteasyProviderFactory factory) {
  ...
  public ResteasyDeployment resteasyDeployment(
      Registry registry, Dispatcher dispatcher, ResteasyProviderFactory factory) {
  ...
  public SpringBeanProcessor springBeanProcessor(
      Registry registry, ResteasyDeployment deployment, ResteasyProviderFactory factory) {
