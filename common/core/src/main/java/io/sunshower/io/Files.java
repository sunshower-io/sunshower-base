...
public class Files {
  ...
  public static byte[] read(File write) throws IOException {
    ...
    try (BufferedInputStream bis = new BufferedInputStream(new FileInputStream(write))) {
      copy(bis, bos, 4092);
    }
  ...
  public static void copy(Reader reader, BufferedWriter writer) throws IOException {
