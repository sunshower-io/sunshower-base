...
public class LazyPropertyAwareTest {
    ...
    public void ensurePropertyAwareHasPropertyReturnsFalseWhenNoPropertyIsAdded() {
        assertThat(new io.sunshower.arcus.incant.LazyPropertyAware().hasProperty("hello"), is(false));
    }

    @Test
    public void ensureHasPropertyReturnsFalseWhenPropertiesIsEmpty () {

        PropertyAware aware = new io.sunshower.arcus.incant.LazyPropertyAware();
    ...
    public void ensureGettingNonExistantPropertyReturnsNothing() {
        assertThat(new io.sunshower.arcus.incant.LazyPropertyAware().getProperty("whatever"), is(nullValue()));
    }
