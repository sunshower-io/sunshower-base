...
public class Configurations {
    ...
    private static HibernateDialectProperties resolve(ConfigurationProvider provider, HibernateProviderConfigurationSource source) {
        return null;
...
//        properties.put("jpa.dialect", provider.getDialect());
    ...
    private static void configureDiagnostics(HibernateDialectProperties dialect, Properties properties) {
