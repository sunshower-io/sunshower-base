...
public class HibernateConfigurationTest {
    ...
    @Inject
    private PersistenceUnit configuration;

    @PersistenceContext
    private EntityManager entityManager;

    @Inject
    private TestConfig contextConfiguration;
...
//    @Test
//    public void ensureLuceneCanBeLoaded() throws ClassNotFoundException {
//        Class.forName("org.apache.lucene.search.similarities.DefaultSimilarity");
//    }
    ...
    public void ensureConfigurationHasCorrectScannedPacakges() {
        HashSet<String> strings = new HashSet<>(Arrays.asList(
                "test.entities",
